...
(defconst jove-syntax-word-chars '(${generate([... identifierStart])})
"List of identifier start characters and character ranges.")

(defconst jove-syntax-symbol-chars '(${generate([... identifierPart])})
"List of identifier part characters and character ranges.")

(provide 'jove-identifier)

;;; jove-identifier.el ends here`)
